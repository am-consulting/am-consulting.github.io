...
txt <- ''
for(iii in seq(length(title))){
  txt <- 
    paste0(txt,'<b>',title[iii],'</b><br>\n')
  txt <- 
    paste0(txt,
           '<a href="http://indicator.am-consulting.co.jp/AMCC-TSforecast/AMCC-forecast-arima',iii,'.png">\n')
  txt <- 
    paste0(txt,
           '<img border="2" src="http://indicator.am-consulting.co.jp/AMCC-TSforecast/AMCC-forecast-arima',iii,'.png" width="20%" />\n')
  txt <-
    paste0(txt,'ARIMA\n</a>\n')
  txt <- 
    paste0(txt,
           '<a href="http://indicator.am-consulting.co.jp/AMCC-TSforecast/AMCC-forecast-residual',iii,'.png">\n')
  txt <- 
    paste0(txt,
           '<img border="2" src="http://indicator.am-consulting.co.jp/AMCC-TSforecast/AMCC-forecast-residual',iii,'.png" width="20%" />\n')
  txt <-
    paste0(txt,'Residual\n</a>\n')
  txt <- 
    paste0(txt,
           '<a href="http://indicator.am-consulting.co.jp/AMCC-TSforecast/AMCC-forecast-boxtest',iii,'.png">\n')
  txt <- 
    paste0(txt,
           '<img border="2" src="http://indicator.am-consulting.co.jp/AMCC-TSforecast/AMCC-forecast-boxtest',iii,'.png" width="20%" />\n')
  txt <-
    paste0(txt,'Ljung-Box test\n</a>\n<br>')
}
  setwd(pathOutputForecast)
write.table(x = txt,file = 'AMCC-TS-Forecast.html',append = F,
