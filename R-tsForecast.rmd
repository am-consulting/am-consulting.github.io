...
for(iii in seq(length(title))){
  ...
  txt <- 
    paste0(txt,
           '<img border="2" src="http://indicator.am-consulting.co.jp/AMCC-TSforecast/AMCC-forecast-arima',iii,'.png" width="30%" />\n')
  txt <-
    paste0(txt,'ARIMA\n</a>\n')
  txt <- 
    paste0(txt,
  ...
  txt <- 
    paste0(txt,
           '<img border="2" src="http://indicator.am-consulting.co.jp/AMCC-TSforecast/AMCC-forecast-residual',iii,'.png" width="30%" />\n')
  txt <-
    paste0(txt,'Residual\n</a>\n')
  txt <- 
    paste0(txt,
  ...
  txt <- 
    paste0(txt,
           '<img border="2" src="http://indicator.am-consulting.co.jp/AMCC-TSforecast/AMCC-forecast-boxtest',iii,'.png" width="30%" />\n')
  txt <-
