...
dataTitle<-'国内総生産(支出側)-実質季節調整値(単位:10億円) 2016年4-6月期'
dataSource<-'内閣府'
...
legend(
  "topleft",
  legend=c('Raw Data',paste0('Hodrick-Prescott filter.λ=',tsDataHPfilter$lambda)),
  col=1:2, 
  lty=rep(1,2), 
  ncol=1, 
  lwd=1
...
legend(
  "topleft",
  legend=c(paste0('Hodrick-Prescott filter.λ=',tsDataHPfilter$lambda), 'Baxter-King Filter','Christiano-Fitzgerald Filter'),
  col=1:3, 
  lty=rep(1,3), 
  ncol=1, 
  lwd=1
