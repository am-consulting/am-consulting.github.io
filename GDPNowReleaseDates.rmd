...
colnames(buf)[1] <- paste0(colnames(buf)[1],'. Caution:Checked By AMCC At ',Sys.time(),'(JST)')
...
setwd(pathOutput)
write.csv(x = buf, file = "GDPNowReleaseDates.csv", quote = T, row.names = F, append = F, fileEncoding = 'utf8')
```
