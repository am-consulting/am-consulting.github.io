...
cols <- c('Safe'='blue','Tense'='green','Dangerous'='red')
fun_plot(iii = 5)
...
g <- g + geom_point(aes(y = obj[,2],colour = colnames(obj)[2]),size = 1)
if(iii<=7){
  g <- g + geom_line(aes(y = obj[,3],colour = colnames(obj)[3]))
  g <- g + geom_point(aes(y = obj[,3],colour = colnames(obj)[3]),size = 1)
}
if(iii == 5){
  g <- g + geom_line(aes(y = obj[,4],colour = colnames(obj)[4]))
  g <- g + geom_point(aes(y = obj[,4],colour = colnames(obj)[4]),size = 1)
}
