...
importAMCC <-
  c('importMonetarybaseOfJapan-2017.r','importJapanPropertyPriceIndexREV.r')
...
fun_JapanPropertyPriceIndexREV(sheetName = '全国')
wholeData <- 
  JapanPropertyPriceIndex1
fun_JapanPropertyPriceIndexREV(sheetName = '東京都')
tokyoData <- 
  JapanPropertyPriceIndex1
```
...
- Source http://tochi.mlit.go.jp/?post_type=secondpage&p=15623
