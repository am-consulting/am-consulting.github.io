...
fun_dataTable(obj = componentGDPNow,title = paste0('GDPNow. データ取得日時:',dataImportedTime),dateFormat = 0)
```
...
```{r warning=F,error=F,message=F,echo=F,results='asis'}
fun_dataTable(obj = contributionsGDPNow,title = paste0('GDPNow. データ取得日時:',dataImportedTime),dateFormat = 0)
```
