...
```{r warning=F,error=F,message=F,echo=F,results='asis'}
fun_transposeDataFrame(obj = allData,tailN = 3,dateFormat = dateFormat)
fun_markdownTable(obj = tDF)
```

```{r warning=F,error=F,message=F,echo=F,results='hide'}
fun_makeDiffTable(obj = na.omit(allData),lag = 1)
fun_transposeDataFrame(obj = diffDF,tailN = 2,dateFormat = dateFormat)
fun_markdownTable(obj = tDF)
```
