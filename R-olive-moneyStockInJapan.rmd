...
n1 <- 1
fun_plot_dygraph(obj = dataSet, n0 = n1, dygraphTitle = 'マネーストックとマネタリーベース', legendWidth = 300)
...
fun_plot_dygraph(obj = creditMultiplier, n0 = n2, dygraphTitle = 'マネーストック毎の信用乗数', legendWidth = 300)
fun_dygraph_shade(n = n2)
```
