...
needAdd<-0
pp<-1
dataTitle<-'OTC foreign exchange turnover by currency pair - Daily averages in April, in billions of US dollars and percentages - 2001-2016 - Triennial Central Bank Survey'
...
<hr>
```{r,warning=F,error=F,message=F,echo=F} 
#funPlotBoxplotAmcharts(obj = dataSetDT[, 4:6], bigTitle = paste0(dataTitle, ' - 基本統計量'))
```
