...
dateFormat <- '%Y年%m月'
fun_makeDiffRatioTable(obj = RealExportsAndRealImports01[,-4],lag = 1)
...
obj <- developmentsInRealExportsAndRealImports[,c(1,2,3,4)]
...
```{r warning=F, error=F, message=F, echo=F,results='asis'}
obj <- developmentsInRealExportsAndRealImports[,c(1,2,3)]
