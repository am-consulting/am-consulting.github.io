...
dataTitle <- '日本の国税の時系列推移 - 申告所得税、消費税、法人税、源泉所得税'
dataSource <- '国税庁'
...
if(dateFormat == '%Y年'){
bufDF <- dataSet[c(nrow(dataSet),nrow(dataSet)-1,nrow(dataSet)-2),]
}
if(quarterly==1){
