...
appendText <- 
  paste0('. 前週差 - ', paste0(paste0(colnames(dataSet)[-1],
                                   ':', tail(round(diff(as.matrix(dataSet[,-1])),1),1)),collapse = ' , '))
dataTitle <- 
  paste0('U.S. Weekly Leading Index(weekly) - ', 
         format(tail(dataSet[, 1], 1), dateFormat), appendText)
