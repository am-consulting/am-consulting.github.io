...
n <- 1
fun_generateKnit(objDF = origData1[,c(1,2,4)],plotNum = n,dygraphTitle = 'ドル建て(百万ドル)')
...
fun_transposeDataFrame(obj = origData1,tailN = 3,dateFormat = dateFormat)
tDF[,1] <-
  gsub('.+/(.+)','\\1',tDF[,1])
cat('#### 日本の外貨準備高(単位:百万ドル)')
