...
<style>.main-container {max-width : 1400px;}</style>
...
dataTitle <- 
  paste0('Database Of ',countryName)
dataSource <- 
  'IMF,OECD,CIA'
options(scipen = 999)
```
...
### Data From World Economic Outlook Databases(IMF)
...
OECDdata[,1] <- iconv(OECDdata[,1],from = 'utf8',to = 'utf8')
