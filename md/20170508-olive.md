...
# 消費動向調査:消費者態度指数(二人以上の世帯,季節調整値):前月差:2017年04月:消費者態度指数:-0.7 , 消費者態度指数を構成する消費者意識指標-暮らし向き:-1.2 , 消費者態度指数を構成する消費者意識指標-収入の増え方:-0.8 , 消費者態度指数を構成する消費者意識指標-雇用環境:0.8 , 消費者態度指数を構成する消費者意識指標-耐久消費財の買い時判断:-1.6 , その他の消費者意識指標-資産価値:-1.7

<a href="http://knowledgevault.saecanet.com/charts/chartImages/consumerConfidenceSurvey.png"><img border="0" src="http://knowledgevault.saecanet.com/charts/chartImages/consumerConfidenceSurvey.png" width="100%" /></a>
