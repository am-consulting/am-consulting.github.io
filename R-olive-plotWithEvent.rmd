...
statResultDF[4,1]<-3
statResultDF[4,2]<-'平均1日当り入域隻'
statResultDF[4,3]<-round(totalShip/dateDiff,2)
statResultDF[4,4]<-paste0('=',totalShip,'隻/',dateDiff,'日(',first(statDataSet[, 2]),'~',last(statDataSet[, 2]),')')
