...
dataTitle <- '平成27年 人口速報集計(要計表による人口集計) - 人口，人口増減(平成22年～27年)，面積，人口密度，世帯数及び世帯数増減(平成22年～27年) - 全国，全国市部・郡部，都道府県，都道府県市部・郡部，市区町村 - 公表日:平成28年2月26日'
dataSource <- '総務省'
...
tmp0[,buf] <- apply(tmp0[,buf],2,function(x) round(x,2))
