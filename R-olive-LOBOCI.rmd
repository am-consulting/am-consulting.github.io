...
dataTitle0 <- format(tail(LOBOCI[,1],1),'%Y年%m月')
dataSource <- "日本商工会議所"
...
knitr::kable(fun_transposeDataFrame(obj = LOBOCI, tailN = 8, dateFormat = '%Y年%m月'),
             row.names = F,
