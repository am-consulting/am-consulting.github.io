...
library(Nippon)
folder.name <- 'FEH_00350600_170901162544'
csvFile <- paste0(folder.name,'.csv')
baseURL <- paste0('https://github.com/am-consulting/am-consulting.github.io/raw/master/csv/csvData/TSdata/',folder.name,'/')
...
txt <- paste0('<table id="amcc">\n<tr><th>項目</th><th>チャート</th></tr>\n',txt,'</table>')
setwd(pathOutputCorporateStatistics)
