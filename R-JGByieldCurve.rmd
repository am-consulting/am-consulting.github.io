...
buf0 <-
  read.csv(fileName,header = F,skip = 0,stringsAsFactor = F,check.names = F,
           fileEncoding = 'UTF8')
pathOutput <- paste0('C:/Users/',userName,buf0[2,1],'charts/indicator/JGByieldCurve/')
```
...
for(rrr in seq(nrow(obj))){
  num <- formatC(rrr,width = 3,format = "d",flag = "0")
  txt <- 
    paste0(txt,
